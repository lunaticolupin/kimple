...
--declare
--begin
    select wh.work_header_id, wh.cod_sgae, dc1.doc_date, wc.start_effectivity_date, 
    ...
    w.distribution_typology_id, w.nationality_id, w.work_length, w.music_length,
    e.work_length, e.music_length, v.version_id,
    case when 
